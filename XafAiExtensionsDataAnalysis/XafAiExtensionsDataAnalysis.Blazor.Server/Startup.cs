...
using XafAiExtensionsDataAnalysis.Blazor.Server.Services;
...
using XafAiExtensionsDataAnalysis.WebApi.JWT;
using DevExpress.ExpressApp.Security.Authentication;
using DevExpress.ExpressApp.Security.Authentication.ClientServer;

namespace XafAiExtensionsDataAnalysis.Blazor.Server;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<XafAiExtensionsDataAnalysisBlazorApplication>();
            ...
            builder.Modules
                ...
                .AddViewVariants()
                .Add<XafAiExtensionsDataAnalysis.Module.XafAiExtensionsDataAnalysisModule>()
                .Add<XafAiExtensionsDataAnalysisBlazorModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(XafAiExtensionsDataAnalysis.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(XafAiExtensionsDataAnalysis.Module.BusinessObjects.ApplicationUserLoginInfo);
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "XafAiExtensionsDataAnalysis API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the XafAiExtensionsDataAnalysis.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
            });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "XafAiExtensionsDataAnalysis WebApi v1");
            });
        }
        else {
